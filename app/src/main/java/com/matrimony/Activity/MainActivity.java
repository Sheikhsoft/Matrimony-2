...
import com.matrimony.fragments.HomeFragment;
import com.matrimony.fragments.MatchFragment;
...
public class MainActivity extends AppCompatActivity {
   ...
   // index to identify current nav menu item
    ...
    private static final String TAG_SETTINGS = "Update Profile";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Searching for Near by Garges", Snackbar.LENGTH_LONG)
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText("Vinod Kamble");
        txtWebsite.setText("Software Developer");
    ...
    private void loadHomeFragment() {
        ...
        // when swihing betwetcen navigation menus
